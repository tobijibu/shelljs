# ShellJSドキュメント翻訳
[ShellJS](https://documentup.com/shelljs/shelljs)は、Node.jsのAPIを使ったコマンド実装ライブラリです。
シェルスクリプトをJavaScriptに置き換える必要がありますが、Node.jsさえインストールすれば、どのプラットフォームでも同じシェルスクリプトを使うことができます。

ここではShellJS公式サイトのドキュメントを日本語に翻訳・改変してまとめています。  
定期的に更新しますが、情報が古かったり、間違った内容が書かれている可能性があります。

最新の情報は[公式サイト](https://documentup.com/shelljs/shelljs)をご確認ください。

## 本サイト
このリポジトリは以下のサイトをHTML形式で出力したものです。  
https://tr.you84815.space/shelljs/
